...
$stmt = $pdo->prepare('INSERT INTO images(image_title, image_name, created_at) VALUES(:image_title, :image_name, :created_at)');
$stmt->bindValue(':image_title', $_POST['image_title'], PDO::PARAM_STR);
